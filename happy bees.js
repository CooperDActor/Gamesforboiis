...
/* This file is hosted on github.com */
/* **************************************** */
...
(function() {
	...
	if (isMobile() && window.matchMedia("(pointer: coarse)").matches) {
		html.push(
			'<div class="ZMgameDiv" style="text-align:center">',
		...
		html.push(
			'<iframe class="ZMgameFrame" src="' + url + '" width="' + width + '" height="' + height + '" frameborder="0" style="display:block" allowfullscreen></iframe>'
		);
	}
